...
from baderkit.ui.gui.widgets import ColorPicker, DoubleSpinBox, SpinBox
...
class ViewTab(qw.QWidget):
    ...
    def __init__(self, main, parent=None):
        ...
        self.light_intensity = DoubleSpinBox(
            min_value=0.01,
            max_value=1.00,
            plot_prop="light_intensity",
            main=main,
            current_value=1.0,
        )
        self.basic_layout.addRow("Light Intensity", self.light_intensity)
