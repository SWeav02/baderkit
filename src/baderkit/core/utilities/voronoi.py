...
def get_neighs_in_planes(
    ...
    plane_ranges = np.insert(
        plane_ranges, 
        np.array((0,len(plane_ranges))),
        np.array((0,len(site_indices)))
        )
...
def get_cell_wrapped_voronoi(
    ...
    return all_site_indices, all_transforms, all_plane_points, all_plane_vectors, all_plane_volumes
