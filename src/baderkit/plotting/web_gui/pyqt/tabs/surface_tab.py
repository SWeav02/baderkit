...
from baderkit.plotting.web_gui.pyqt.widgets import DoubleSpinBox, ColorPicker
...
class SurfaceTab(qw.QWidget):
    ...
    def __init__(self, main, parent=None):
        ...
        self.iso_val = DoubleSpinBox(decimals=4, step_size=0.01, main=main, plot_prop="iso_val")
        ...
        surface_layout.setAlignment(surface_color_box, Qt.AlignVCenter)  # center vertically
        ...
        use_solid_surface_color.setSizePolicy(qw.QSizePolicy.Minimum, qw.QSizePolicy.Preferred)
        ...
        self.surface_color.setSizePolicy(qw.QSizePolicy.Expanding, qw.QSizePolicy.Preferred)
        ...
        # force checkbox to its natural (fixed/minimum) width so it doesn't stretch
        use_solid_cap_color.setSizePolicy(qw.QSizePolicy.Minimum, qw.QSizePolicy.Preferred)
        ...
        self.cap_color.setSizePolicy(qw.QSizePolicy.Expanding, qw.QSizePolicy.Preferred)
    ...
    def set_bader(self):
        ...
        self.iso_range.setText(f"({round(bader_plotter.min_val, 4)} - {round(bader_plotter.max_val, 4)})")
