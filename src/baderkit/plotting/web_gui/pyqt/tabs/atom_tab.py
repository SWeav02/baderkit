...
class AtomsTab(qw.QWidget):
    ...
    def set_bader(self):
        ...
        for symbol in species:
            ...
            self.tree.setItemWidget(item, 1, centered_widget(radius_widget))
            self.tree.setItemWidget(item, 2, centered_widget(color_widget))
            self.tree.setItemWidget(item, 3, centered_widget(visible_widget))
        ...
        for site in structure:
            ...
            self.tree.setItemWidget(atom_item, 1, centered_widget(radius_widget))
            self.tree.setItemWidget(atom_item, 2, centered_widget(color_widget))
            self.tree.setItemWidget(atom_item, 3, centered_widget(visible_widget))
