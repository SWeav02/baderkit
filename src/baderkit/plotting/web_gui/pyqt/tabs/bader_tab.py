...
from baderkit.plotting.web_gui.pyqt.widgets import FilePicker, DoubleSpinBox, ErrorWindow
...
class BaderWorker(qc.QObject):
    ...
    def __init__(self, charge_path, reference_path, method, vacuum_tol, basin_tol,):
        super().__init__()
