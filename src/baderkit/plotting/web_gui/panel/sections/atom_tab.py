...
def get_atom_widgets(plotter: BaderPlotter, pane):
    ...
    rows = [(
        pn.pane.Markdown("Label", align=("center", "end"),),
        pn.pane.Markdown("Visible", align=("center", "end"),),
        pn.pane.Markdown("Color", align=("center", "end"),sizing_mode='stretch_width'),
        pn.pane.Markdown("Radius", align=("center", "end"),sizing_mode='stretch_width'),
        )]
